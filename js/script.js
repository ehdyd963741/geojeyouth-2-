...
window.onload = function () {
  ...
  // 활동 갤러리 함수 작성
  // 자료를 전달을 하면 활동 갤러리 목록에
  // 출력을 한다. (링크, 사진, 날짜, 제목)
  // 특정한 html 의 요소에 출력을 해야 한다.
  // 출력할 데이터 모음
  let galleryData = [
    {
      link: "#",
  ...
  showGalleryInfo("#aaa", galleryData[1]);
  showGalleryInfo("#bbb", galleryData[2]);
...
//goTop('클래스명')
// default값ㄱ
// function goTop(_el, _speed=1000)  {
//    $(_el).click(function(event){
//          //a 태그의 경우 href 를 제어한다. (웹브라우저 갱신)
